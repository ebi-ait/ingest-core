...
class MetadataDocumentSerializationTest {
    ...
    @ParameterizedTest()
    @MethodSource("testData")
    public void testDeserialization(Supplier<Object> objectSupplier, String expectedJson) throws JsonProcessingException {
    ...
    @ParameterizedTest()
    @MethodSource("testData")
    public void testSerializationThenDeserialization(Supplier<Object> objectSupplier, String expectedJson) throws JsonProcessingException {
        Object someObject = objectSupplier.get();
        String json = objectMapper.writeValueAsString(someObject);
