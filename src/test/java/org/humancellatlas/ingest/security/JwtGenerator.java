...
public class JwtGenerator {
    ...
    /**
     * Creates an instance with a pre-defined default issuer. This issuer <b>>will be overridden</b> by "iss" claim
     * during when generating the JWT if it is set.
     *
     * @param issuer
     */
    //The decision to allow "iss" claim to override the issuer field is so that UserInfo can be encoded with little
    ...
    public String generate(@Nullable String keyId, @Nullable String subject, @Nullable Map<String, String> claims) {
        ...
        JWTCreator.Builder builder = JWT.create()
                ...
                .withIssuer(Optional.ofNullable(allClaims.get(OIDC_ISS))
                        .orElse(issuer))
                .withSubject(Optional.ofNullable(subject)
