package uk.ac.ebi.subs.ingest.migrations;
...
public class MongoChangeLog {
  ...
  @ChangeSet(
      order = "2019-10-30",
      id = "featureCompatibilityVersion 3.4",
      author = "alexie.staffer@ebi.ac.uk")
  ...
  @ChangeSet(
      order = "2019-10-31",
      id = "featureCompatibilityVersion 3.6",
      author = "alexie.staffer@ebi.ac.uk")
  ...
  @ChangeSet(
      order = "2019-11-01",
      id = "featureCompatibilityVersion 4.0",
      author = "alexie.staffer@ebi.ac.uk")
  ...
  @ChangeSet(
      order = "2019-11-02",
      id = "featureCompatibilityVersion 4.2",
      author = "alexie.staffer@ebi.ac.uk")
  ...
  @ChangeSet(
      order = "2019-11-03",
      id = "singletonSubmissionEnvelope Biomaterial",
      author = "alexie.staffer@ebi.ac.uk")
  public void singletonSubmissionEnvelopeBiomaterial(MongoDatabase db) {
    ...
    update.add(
        new Document(
            "$set",
            Document.parse(
                "{ submissionEnvelope: { $arrayElemAt: [ \"$submissionEnvelopes\", 0 ] } }")));
  ...
  @ChangeSet(
      order = "2019-11-04",
      id = "singletonSubmissionEnvelope Process",
      author = "alexie.staffer@ebi.ac.uk")
  ...
  @ChangeSet(
      order = "2019-11-05",
      id = "singletonSubmissionEnvelope Protocol",
      author = "alexie.staffer@ebi.ac.uk")
  ...
  @ChangeSet(
      order = "2019-11-06",
      id = "singletonSubmissionEnvelope File",
      author = "alexie.staffer@ebi.ac.uk")
  ...
  @ChangeSet(
      order = "2019-11-07",
      id = "singletonSubmissionEnvelope Project",
      author = "alexie.staffer@ebi.ac.uk")
  ...
  @ChangeSet(
      order = "2020-08-11",
      id = "Drop Alias Index on archiveEntity",
      author = "karoly@ebi.ac.uk")
  ...
  @ChangeSet(
      order = "2020-09-15",
      id = "singelton project.dataAccess.type",
      author = "alexie.staffer@ebi.ac.uk")
  public void singeltonProjectDataAccessType(MongoDatabase db) {
    ...
    update.add(
        new Document(
            "$set",
            Document.parse("{ 'dataAccess.type': { $arrayElemAt: [ '$dataAccess.type', 0 ] } }")));
    db.getCollection("project").updateMany(filter, update);
  }

  @ChangeSet(
      order = "2021-05-20",
      id = "set default publications info",
      author = "alexie.staffer@ebi.ac.uk")
  ...
  @ChangeSet(
      order = "2021-11-22",
      id = "Set empty graphValidationErrors",
      author = "jcbwndsr@ebi.ac.uk")
  ...
  public void renameSubmissionStates(MongoDatabase db) {
    ...
    update.add(
        new Document("$set", Document.parse("{ 'submissionState': 'METADATA_VALIDATING' }")));
    db.getCollection("submissionEnvelope").updateMany(filter, update);
  ...
  public void addSubmissionEnvelopeIndexToProcess(MongoDatabase db) {
    db.getCollection("process").createIndex(Document.parse("{ \"submissionEnvelope\": 1 }"));
  }
}
