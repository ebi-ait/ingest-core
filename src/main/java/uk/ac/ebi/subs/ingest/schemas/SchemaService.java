...
import uk.ac.ebi.subs.ingest.schemas.schemascraper.SchemaScraper;
import uk.ac.ebi.subs.ingest.schemas.schemascraper.impl.SchemaScrapeException;
  ...
  private Schema schemaDescriptionFromSchemaUri(URI schemaUri) {
    ...
    try {
      ...
      if ("bundle".equals(highLevelEntity) && splitString.length == 3) {
        ...
        return new Schema(
            highLevelEntity, version, domainEntity, subDomainEntity, concreteEntity, schemaFullUri);
      }
