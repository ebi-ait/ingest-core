 ...
 *
 * Behaviour:
 *  - If the principal is already a persisted Account (id != null):
 *      → return it as-is (Globus or already-registered Cognito user).
 *  - If the principal is an Account with id == null:
