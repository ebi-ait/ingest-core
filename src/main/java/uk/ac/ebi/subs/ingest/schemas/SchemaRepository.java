...
public interface SchemaRepository extends MongoRepository<Schema, String> {
  ...
  @RestResource
  Page<Schema> findBySchemaVersionAfter(
      @Param("schema-version-range") String schemaVersionRange, Pageable pageable);
  ...
  @Query(
      "{$and :["
          ...
          + "]}")
  Page<Schema> querySchemas(
      @Param("high-level-entity") String highLevelEntity,
