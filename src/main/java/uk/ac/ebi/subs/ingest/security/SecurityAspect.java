...
public class SecurityAspect {
  ...
  /**
   * Advice that runs before any method with the CheckAllowed annotation. Parses the given SpEL in
   * the annotation and throws error if the result returns False.
   *
   * @param joinPoint
   * @throws Throwable
   */
  @Before("@annotation(uk.ac.ebi.subs.ingest.security.CheckAllowed) && execution(* *(..))")
