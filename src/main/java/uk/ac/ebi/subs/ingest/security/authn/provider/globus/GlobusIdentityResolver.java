...
public class GlobusIdentityResolver {
   ...
   *
   * <p>Priority: 1) X-Globus-Identity header (for legacy / Cognito-based clients) 2)
   * Account.providerReference (for Globus-authenticated users) 3) auth.getName() as a last-resort
   * fallback
   */
