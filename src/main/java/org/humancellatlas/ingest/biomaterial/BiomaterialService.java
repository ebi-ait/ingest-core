...
public class BiomaterialService {
    ...
    public Biomaterial addBiomaterialToSubmissionEnvelope(final SubmissionEnvelope submissionEnvelope, final Biomaterial biomaterial) {
    ...
    public Biomaterial addChildBiomaterial(final String parentId, final Biomaterial childBiomaterial) {
        final Biomaterial parentBiomaterial = biomaterialRepository.findById(parentId)
    ...
    public Biomaterial removeChildBiomaterial(final String parentId, final String childId) {
        ...
        final Biomaterial childBiomaterial = biomaterialRepository.findById(childId)
    ...
    public Biomaterial addParentBiomaterial(final String childId, final Biomaterial parentBiomaterial) {
        final Biomaterial childBiomaterial = biomaterialRepository.findById(childId)
                .orElseThrow(() -> new RuntimeException("Child biomaterial not found"));
