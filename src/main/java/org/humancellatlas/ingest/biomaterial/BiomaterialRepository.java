...
public interface BiomaterialRepository extends MongoRepository<Biomaterial, String> {
  ...
  Page<Biomaterial> findBySubmissionEnvelopesContainingAndValidationState(@Param("envelopeId") SubmissionEnvelope submissionEnvelope, @Param("validationState") ValidationState state, Pageable pageable);
