...
public class BiomaterialController {
    ...
    ResponseEntity<Resource<?>> addBiomaterialToEnvelope(
        ...
        final Biomaterial entity = biomaterialService.addBiomaterialToSubmissionEnvelope(submissionEnvelope, biomaterial);
    ...
    HttpEntity<?> linkBiomaterialAsInputToProcesses(
            ...
            final HttpMethod requestMethod) throws URISyntaxException, InvocationTargetException, NoSuchMethodException, IllegalAccessException {

        final List<Process> processes = uriToEntityConversionService.convertLinks(incoming.getLinks(), Process.class);
    ...
    HttpEntity<?> unlinkBiomaterialAsInputToProcesses(
            @PathVariable("id") final Biomaterial biomaterial,
            @PathVariable("processId") final Process process) throws InvocationTargetException, NoSuchMethodException, IllegalAccessException {
    ...
    public ResponseEntity<Resource<?>> addChildBiomaterial(@PathVariable final String parentId,
                                                           @RequestBody final Biomaterial childBiomaterial,
                                                           final PersistentEntityResourceAssembler assembler) {
        final Biomaterial updatedParent = biomaterialService.addChildBiomaterial(parentId, childBiomaterial);
    ...
    public ResponseEntity<Resource<?>> removeChildBiomaterial(@PathVariable final String parentId,
    ...
    public ResponseEntity<Resource<?>> addParentBiomaterial(@PathVariable final String childId,
                                                            @RequestBody final Biomaterial parentBiomaterial,
                                                            final PersistentEntityResourceAssembler assembler) {
        final Biomaterial updatedChild = biomaterialService.addParentBiomaterial(childId, parentBiomaterial);
    ...
    public ResponseEntity<Resource<?>> removeParentBiomaterial(@PathVariable final String childId,
