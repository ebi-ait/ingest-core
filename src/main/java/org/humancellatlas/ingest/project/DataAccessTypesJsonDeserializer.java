...
/** Deserialises {@link DataAccessTypes} JSON value. to enum Used when reading json input. */
public class DataAccessTypesJsonDeserializer extends StdDeserializer<DataAccessTypes> {
  ...
  @Override
  public DataAccessTypes deserialize(JsonParser p, DeserializationContext ctxt)
