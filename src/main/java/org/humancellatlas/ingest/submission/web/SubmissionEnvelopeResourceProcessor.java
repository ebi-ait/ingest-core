...
public class SubmissionEnvelopeResourceProcessor
    implements ResourceProcessor<Resource<SubmissionEnvelope>> {
  ...
  private Link getBiomaterialsLink(SubmissionEnvelope submissionEnvelope) {
    return entityLinks
        .linkForSingleResource(submissionEnvelope)
  ...
  private Link getDatasetsLink(SubmissionEnvelope submissionEnvelope) {
    return entityLinks
        .linkForSingleResource(submissionEnvelope)
        .slash(Links.DATASETS_URL)
        .withRel(Links.DATASETS_REL);
  }
  ...
  private Optional<Link> getStateTransitionLink(
      SubmissionEnvelope submissionEnvelope, SubmissionState targetState) {
    Optional<String> transitionResourceName =
        getSubresourceNameForRequestSubmissionState(submissionEnvelope, targetState);
  ...
  private Optional<Link> getCommitStateTransitionLink(
      SubmissionEnvelope submissionEnvelope, SubmissionState targetState) {
    Optional<String> transitionResourceName =
        getSubresourceNameForCommitSubmissionState(targetState);
    if (transitionResourceName.isPresent()) {
  ...
  private Optional<String> getSubmitLink(SubmissionEnvelope submissionEnvelope) {
    SubmissionManifest submissionManifest =
        this.submissionManifestRepository.findBySubmissionEnvelopeId(submissionEnvelope.getId());

    if (submissionManifest == null) return Optional.of(Links.SUBMIT_URL);
    else if (submissionManifest.getExpectedLinks() != null
  ...
  private Optional<String> getSubresourceNameForRequestSubmissionState(
      SubmissionEnvelope submissionEnvelope, SubmissionState submissionState) {
    switch (submissionState) {
      case SUBMITTED:
  ...
  private Optional<String> getSubresourceNameForCommitSubmissionState(
  ...
  public Resource<SubmissionEnvelope> process(Resource<SubmissionEnvelope> resource) {
    ...
    resource.add(getDatasetsLink(submissionEnvelope));
