...
public class SubmissionEnvelope extends AbstractEntity {
  ...
  public boolean isSystemEditable() {
    // The importer and validator have to add and edit metadata and perform linking while the
    // submission
    // may be in METADATA_VALIDATING
    // So, this is used for the special case of allowing ingest components to function
    // If anything, this highlights problems with the system design - we have many dependencies
    // across domain
    // boundaries
